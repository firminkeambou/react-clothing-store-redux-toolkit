...
import {
  ...
  query,
  getDocs,
  QueryDocumentSnapshot, // type of a firebase Snapshot(representation of a database) as firebase knows from which collection the query was made
